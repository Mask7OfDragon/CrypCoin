 ...
 */
  ...
  # Vista principal de conversiones.
  
  function Currency() {

    $url = 'https://min-api.cryptocompare.com/data/pricemulti?fsyms=XLM,XRP,BTC,ETH,LTC,DASH,XMR,ZEC,DOGE,XDN,XLM,NAV,ETC&tsyms=USD';
...
<html lang="en">
  <head>
    ...
    <title><?php echo APP_TITLE ?> · Inicio</title>
  ...
  <body>
    ...
    <div class="container">
      ...
      <?php 
        ...
        foreach(Currency() as $cc => $value) {

           echo '<div class="col-sm-2 p-2">
                  <div class="card">
                    <div class="card-block">
                      <h4 class="card-title">'. $cc.'</h4>
                      <h6 class="card-subtitle mb-2 text-muted">cambio de USD</h6>
                      <p class="card-text">'. $value['USD'] .' '. $cc.'</p>
